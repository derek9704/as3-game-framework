package com.brickmice.view.solar
{
	...
	public class SolarTalent extends BmWindow
	{
		/**
		 * 窗口名字.
		 */
		public static const NAME : String = "SolarTalent";
		
		private var _mc:MovieClip;
		
		public function SolarTalent(data : Object)
		{
			var hid:int = data.hid;
			var newTalent:Object = data.newTalent;
			var callback:Function = data.callback;
			
			_mc = new ResSolarTalentWindow;
			super(NAME, _mc);
			...
			var heroData:Object = Data.data.boyHero[hid];
			...
			new BmButton(_mc._substituteTalentBtn, function():void{
				ModelManager.boyHeroModel.replaceBoyHeroTalent(hid, callback);
				closeWindow();
			});
